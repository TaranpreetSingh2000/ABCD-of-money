  ...
  return (
    <>
      <div className="relative z-50">
        ...
        <form className={`fixed top-0 max-w-[500px] h-screen overflow-y-auto no-scrollbar bg-white shadow-lg transform transition-all duration-500 ease-in-out p-12 ${
