...
const plans = [
  { name: "Life Insurance", icon: "/images/life-insurance.svg" },
  { name: "Health Insurance", icon: "/images/health-insurance.svg" },
  { name: "Mutual Funds", icon: "/images/mutual-funds-banner.svg" },
  { name: "Stock & Securities", icon: "/images/stocks-ecurities.svg" },
  { name: "Home Loan", icon: "/images/home-loan-banner.svg" },
  { name: "Personal Loan", icon: "/images/personal-loan-banner.svg" },
  { name: "SME Loan", icon: "/images/sme-loan.svg" },
];
      ...
      >
        ...
        <div className="relative mb-4">
          ...
          <div className="flex items-center gap-2 border border-gray-300 rounded-full pl-5 pr-4 py-3 bg-white shadow-sm focus-within:ring-2 focus-within:ring-red-600">
            <img src={image8} alt="Name input icon" className="w-5 h-5" />
            <input
              id={nameId}
              type="text"
        ...
        <div className="relative mb-4">
          ...
          <div className="flex items-center gap-2 border border-gray-300 rounded-full pl-5 pr-4 py-3 bg-white shadow-sm focus-within:ring-2 focus-within:ring-red-600">
            <img src={image9} alt="Phone input icon" className="w-5 h-5" />
