...
export interface ApiFooterNoteFooterNote extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    socialMediaBlock: Schema.Attribute.Component<
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footerAccordion: Schema.Attribute.Component<'accordion.accordion', true>;
    footerLinksSection: Schema.Attribute.Component<
      'list.redirection-list',
      false
    >;
    footerMiddleSection: Schema.Attribute.Component<
...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    mainHeaderNavigationSection: Schema.Attribute.Component<
...
export interface ApiMiddleNavigationSectionMiddleNavigationSection
  ...
  info: {
    ...
    pluralName: 'middle-navigation-sections';
    singularName: 'middle-navigation-section';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::middle-navigation-section.middle-navigation-section'
    > &
      Schema.Attribute.Private;
    middleNavSection: Schema.Attribute.Component<
...
export interface ApiStickySideWrapperStickySideWrapper
  extends Struct.SingleTypeSchema {
  collectionName: 'sticky_side_wrappers';
  info: {
    displayName: 'Sticky Side Wrapper';
    pluralName: 'sticky-side-wrappers';
    singularName: 'sticky-side-wrapper';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::sticky-side-wrapper.sticky-side-wrapper'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    stickyWrapperComponent: Schema.Attribute.Component<
...
export interface ApiTickerHeaderSectionTickerHeaderSection
  extends Struct.SingleTypeSchema {
  collectionName: 'ticker_header_sections';
  info: {
    displayName: 'Ticker Section';
    pluralName: 'ticker-header-sections';
    singularName: 'ticker-header-section';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::ticker-header-section.ticker-header-section'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    tickerSectionComponent: Schema.Attribute.Component<
